...
async def help(ctx, command_arg : str = None):
    ...
    if command_arg is None:
        ...
        embed.add_field(name = ":musical_note: | Music Commands", value = "`connect`, `play`, `soundcloud`, `search`, `np`, `lyrics`, `loop`, `⭐ equalizer`, `⭐ volume`, `⭐ nightcore`, `⭐ vapourwave`, `⭐ pitch`, `⭐ speed`, `queue`, `shuffle`, `seek`, `pause`, `resume`, `move`, `skip`, `remove`, `skipto`, `clearqueue`, `stop`, `disconnect`. \n\n`album`, `artist`, `playlist`, `track`.", inline = False)
