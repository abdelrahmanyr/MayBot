...
async def help(ctx, command_arg : str = None):
    ...
    if command_arg is None:
        ...
        embed.add_field(name = ":musical_note: | Music Commands", value = "`connect`, `play`, `soundcloud`, `search`, `np`, `loop`, `lyrics`, `lyricsgenius`, `equalizer`, `queue`, `shuffle`, `seek`, `pause`, `resume`, `move`, `skip`, `remove`, `skipto`, `clearqueue`, `stop`, `disconnect`. \n\n`album`, `artist`, `playlist`, `track`.", inline = False)
        '''`⭐ volume`, `⭐ nightcore`, `⭐ vapourwave`, `⭐ pitch`, `⭐ speed`'''
...
client.run("NzQ3OTY1MTI1NTk5ODIxOTE0.X0Wizg.YBP3ru5iZuCkmXtizpjp8jKkroQ")
