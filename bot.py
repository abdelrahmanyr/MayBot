...
async def help(ctx):
    ...
    embed.add_field(name = ":musical_note: | Music Commands", value = "`queen`, `connect`, `play`, `soundcloud`, `search`, `np`, `lyrics`, `volume`, `queue`, `shuffle`, `seek`, `pause`, `resume`, `skip`, `stop`, `disconnect`.", inline = False)
